...
<div id="container" class="container">
    <div id="app-wrapper" data-administrator="<?php if ($administrator ?? null) { echo htmlspecialchars(json_encode($administrator), ENT_QUOTES, 'UTF-8'); } else { echo 'null'; }?>" data-events="<?php echo htmlspecialchars(json_encode($events), ENT_QUOTES, 'UTF-8'); ?>">
