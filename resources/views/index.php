...
<html lang="ja">
  ...
  <body>
    <div id="container" class="container">
      <div id="app-wrapper" data-login-user="<?php if ($user ?? null) {  echo htmlspecialchars(json_encode($user, JSON_NUMERIC_CHECK), ENT_QUOTES, 'UTF-8');  } else { echo 'null'; }?>" data-events="<?php echo htmlspecialchars(json_encode($events), ENT_QUOTES, 'UTF-8'); ?>">
